<%-- 
    Document   : AddBan
    Created on : Jul 22, 2014, 9:13:50 PM
    Author     : Ngo
--%>
...
<tiles:insertTemplate template="Template.jsp">
    <tiles:putAttribute name="body">
        ...
        <form action="add?action=addA&id=${u.user_id}" id="form_1" method="POST">
            ...
            <div class="pad3">
                ...
                <div class="row">
                    Image Name: <br>
                    <input type="text" class="inputTEX" name="txtImage">
                </div>
                <div class="row">
                    Address: <br>
                ...
                <div class="row_select">
                    ...
                    <div class="cols pad_left1">
                        Type of Post :<br>
                        <select name="type_post_id">
                            <c:forEach var="c" items="${myBean.typePost}">
                                <option value="${c.id}">${c.type_value}</option>
                            </c:forEach>
                        </select>
                    </div>
                ...
                <div class="cols pad_left1">
                    Description: <br>
                    <input type="textArea" name ="desciption" class="inputDes"/>
                </div>
                </div>
                <div class="row_select">
                    <div class="cols">
